...
products.forEach((product) => {
  ...
  <form class="flex-auto p-6">
    <div class="flex flex-wrap">
      ...
      <div class="text-sm p-2 text-white rounded ${ratingFun(rating.rate)} font-medium text-slate-400">
        ${rating.rate}
      </div>
    </div>
    ...
    <div class="flex space-x-4 mb-5 text-sm font-medium">
      <div class="flex-auto flex space-x-4">
        ...
        <button class="h-10 px-6 font-semibold rounded-full border border-slate-200 text-slate-900 add_to_cart" type="button">
          Add to bag
        </button>
      </div>
    ...
    singleProduct.querySelector(".buy-now").addEventListener("click", () => {
...
cartButton.addEventListener("click", navigateToProductPage);
...
//     const currentUrl = new URL(window.location.href);
//     currentUrl.searchParam(set("cart", cartItemsIds));
